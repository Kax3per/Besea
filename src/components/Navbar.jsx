...
export default function Navbar() {
  ...
  return (
    <motion.header
      className={`fixed top-0 left-0 w-full z-50 bg-white  flex items-center justify-between px-6 transition-all duration-300 ${
        scrolled ? "h-20" : "h-28"
      }`}
    >
      ...
      <AnimatePresence>
        {pagesOpen && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            transition={{ duration: 0.3 }}
            className="fixed top-28 left-0 w-screen bg-white shadow-[0_-4px_7px_rgba(0,0,0,0.1)]  z-40 py-12"
        ...
        {links.map((link) => (
          <li key={link}>
            {link === "Pages" ? (
              <>
                <div
                  className="flex items-center justify-between cursor-pointer px-4 py-3 text-gray-600 hover:bg-[#00A84F] hover:text-white transition-colors"
                    ...
                    >
                      ...
                      <div className="flex flex-col space-y-3 mb-6">
                        {leftLinks.map((item, i) => (
                          <span
                            key={i}
                            className="cursor-pointer px-4 py-2 transition-colors text-gray-600 hover:bg-[#00A84F] hover:text-white"
                          >
                            {item}
                          </span>
                        ))}
              ...
              <span className="block cursor-pointer px-4 py-3 hover:bg-[#00A84F] hover:text-white transition-colors">
                {link}
              </span>
            )}
          </li>
