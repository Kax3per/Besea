...
export default function WorkingTogether() {
  ...
  return (
<div className="w-full flex flex-col xl:flex-row items-start justify-between py-20 px-6 md:px-12 lg:px-20 bg-white">
      
  {/* Lewa sekcja */}
  <div className="w-full xl:w-1/2 flex flex-col mt-40 items-start mb-10 xl:mb-0">
    ...
    {/* Tekst i przycisk */}
    <div className="mt-4">
      <h3 className="text-4xl mb-5 text-gray-500 font-semibold hover:text-[#00A84F]">
        {steps[active].title}
      </h3>
  ...
  {/* Obrazki */}
<div className="w-full flex flex-col xl:flex-row justify-center items-center gap-6 mt-40 xl:mt-0">
  <img
    src={img1}
    alt="App 03"
    className="object-cover shadow-lg w-full md:w-96 lg:w-[480px] xl:w-80 2xl:w-[400px]"
  />
  <img
    src={img2}
    alt="App 04"
